Feature: Implement BigQuery enriched marts are refreshed within 24 hours (SYN-634)
  Source: Jira ticket SYN-634

  Background:
    Given the QE Quality Agent is reachable

  @JiraGenerated @SYN-634 @SYN-635
