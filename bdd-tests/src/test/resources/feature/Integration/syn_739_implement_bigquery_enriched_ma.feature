Feature: Implement BigQuery enriched marts are refreshed within 24 hours (SYN-739)
  Source: Jira ticket SYN-739

  Background:
    Given the QE Quality Agent is reachable

  @JiraGenerated @SYN-739 @SYN-740
