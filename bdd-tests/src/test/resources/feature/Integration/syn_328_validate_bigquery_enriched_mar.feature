Feature: Validate BigQuery enriched marts are refreshed within 24 hours (SYN-328)
  Source: Jira ticket SYN-328

  Background:
    Given the QE Quality Agent is reachable

  @JiraGenerated @SYN-328 @SYN-329
