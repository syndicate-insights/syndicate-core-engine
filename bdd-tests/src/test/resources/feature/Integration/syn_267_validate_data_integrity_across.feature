Feature: Validate data integrity across BigQuery marts, dbt transformations, and the   Neo4j graph (SYN-267)
  Source: Jira ticket SYN-267

  Background:
    Given the QE Quality Agent is reachable

  @JiraGenerated @SYN-267 @SYN-268
