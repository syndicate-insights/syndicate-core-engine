Feature: Validate data integrity across BigQuery marts, dbt transformations, and the   Neo4j graph (SYN-373)
  Source: Jira ticket SYN-373

  Background:
    Given the QE Quality Agent is reachable

  @JiraGenerated @SYN-373 @SYN-374
