Feature: Implement BigQuery enriched marts are refreshed within 24 hours (SYN-466)
  Source: Jira ticket SYN-466

  Background:
    Given the QE Quality Agent is reachable

  @JiraGenerated @SYN-466 @SYN-467
