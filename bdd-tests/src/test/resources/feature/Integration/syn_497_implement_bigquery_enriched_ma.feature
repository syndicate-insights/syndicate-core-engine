Feature: Implement BigQuery enriched marts are refreshed within 24 hours (SYN-497)
  Source: Jira ticket SYN-497

  Background:
    Given the QE Quality Agent is reachable

  @JiraGenerated @SYN-497 @SYN-498
