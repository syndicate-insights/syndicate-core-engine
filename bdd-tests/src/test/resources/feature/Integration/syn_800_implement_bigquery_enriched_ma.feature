Feature: Implement BigQuery enriched marts are refreshed within 24 hours (SYN-800)
  Source: Jira ticket SYN-800

  Background:
    Given the QE Quality Agent is reachable

  @JiraGenerated @SYN-800 @SYN-801
