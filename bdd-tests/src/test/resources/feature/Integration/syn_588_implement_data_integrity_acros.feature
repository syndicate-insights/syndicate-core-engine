Feature: Implement data integrity across BigQuery marts, dbt transformations, and the   Neo4j graph (SYN-588)
  Source: Jira ticket SYN-588

  Background:
    Given the QE Quality Agent is reachable

  @JiraGenerated @SYN-588 @SYN-589
