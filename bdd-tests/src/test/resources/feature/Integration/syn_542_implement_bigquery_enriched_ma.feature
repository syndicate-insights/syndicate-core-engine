Feature: Implement BigQuery enriched marts are refreshed within 24 hours (SYN-542)
  Source: Jira ticket SYN-542

  Background:
    Given the QE Quality Agent is reachable

  @JiraGenerated @SYN-542 @SYN-543
