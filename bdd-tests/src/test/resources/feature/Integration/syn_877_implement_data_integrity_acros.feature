Feature: Implement data integrity across BigQuery marts, dbt transformations, and the Neo4j graph (SYN-877)
  Source: Jira ticket SYN-877

  Background:
    Given the QE Quality Agent is reachable

  @JiraGenerated @SYN-877 @SYN-878
  ...
  @JiraGenerated @SYN-877 @SYN-879 @manual
