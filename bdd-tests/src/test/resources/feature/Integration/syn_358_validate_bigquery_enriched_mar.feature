Feature: Validate BigQuery enriched marts are refreshed within 24 hours (SYN-358)
  Source: Jira ticket SYN-358

  Background:
    Given the QE Quality Agent is reachable

  @JiraGenerated @SYN-358 @SYN-359
