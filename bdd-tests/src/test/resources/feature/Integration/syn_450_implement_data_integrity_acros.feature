Feature: Implement data integrity across BigQuery marts, dbt transformations, and the   Neo4j graph (SYN-450)
  Source: Jira ticket SYN-450

  Background:
    Given the QE Quality Agent is reachable

  @JiraGenerated @SYN-450 @SYN-451
