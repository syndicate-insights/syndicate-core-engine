Feature: Implement data integrity across BigQuery marts, dbt transformations, and the   Neo4j graph (SYN-784)
  Source: Jira ticket SYN-784

  Background:
    Given the QE Quality Agent is reachable

  @JiraGenerated @SYN-784 @SYN-785
