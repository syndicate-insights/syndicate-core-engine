Feature: Implement BigQuery enriched marts are refreshed within 24 hours (SYN-847)
  Source: Jira ticket SYN-847

  Background:
    Given the QE Quality Agent is reachable

  @JiraGenerated @SYN-847 @SYN-848
