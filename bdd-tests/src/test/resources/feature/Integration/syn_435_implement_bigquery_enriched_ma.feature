Feature: Implement BigQuery enriched marts are refreshed within 24 hours (SYN-435)
  Source: Jira ticket SYN-435

  Background:
    Given the QE Quality Agent is reachable

  @JiraGenerated @SYN-435 @SYN-436
