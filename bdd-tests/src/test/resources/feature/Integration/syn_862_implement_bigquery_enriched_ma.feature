Feature: Implement BigQuery enriched marts are refreshed within 24 hours (SYN-862)
  Source: Jira ticket SYN-862

  Background:
    Given the QE Quality Agent is reachable

  @JiraGenerated @SYN-862 @SYN-863
