Feature: Validate BigQuery enriched marts are refreshed within 24 hours (SYN-389)
  Source: Jira ticket SYN-389

  Background:
    Given the QE Quality Agent is reachable

  @JiraGenerated @SYN-389 @SYN-390
